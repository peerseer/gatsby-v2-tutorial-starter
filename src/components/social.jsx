  ...
  <ShareSocial>
    <ShareItem>
      <ShareLink
        ...
        }&url=https://pappulies.com${post.frontmatter.path}%2F&via=pappulies`}
      >
        <span>
          <svg
    ...
    <ShareItem>
      <ShareLink
        href={`https://www.facebook.com/sharer/sharer.php?u=https://pappulies.com${
    ...
    <ShareItem>
      <ShareLink
        href={`https://www.linkedin.com/shareArticle?mini=true&url=https://pappulies.com${
          post.frontmatter.path
